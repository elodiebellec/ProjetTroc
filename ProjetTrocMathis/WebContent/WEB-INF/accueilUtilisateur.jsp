			...
			<form action="./AccueilUtilisateur" method="post">
				...
				<div>
					<input type="radio" name="typeTransaction" value="vente"> <label
						...
						name="encoursVente" value="encoursVente"> mes ventes en
					cours<br> <input type="checkbox" name="futureVente"
						value="futureVente"> ventes non débutées<br> <input
						type="checkbox" name="venteTerminee" value="venteTerminee">
					ventes terminées<br>
				</div>
